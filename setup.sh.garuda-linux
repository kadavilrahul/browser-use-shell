...
sudo pacman -S --needed --noconfirm \
    ...
    libxcomposite libxdamage libxfixes libxrandr libxkbcommon pango cairo \
    libcups libxss alsa-lib ffmpeg xorg-server-xvfb gconf nss-mdns ttf-liberation \
    libappindicator-gtk3 libxshmfence chromium icu libwebp libffi

# First install playwright without browser download
PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=1 pip install playwright

# Then install browsers manually without system dependencies
